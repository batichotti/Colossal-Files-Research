...
## Minerando commits de Arquivos Colossais

Com isso, tendo todos os Arquivos Colossais separados, o próximo passo foi minerar todos os commits de cada arquivo.
...
Para as próximas análises, precisamos dos commits de arquivos que não são Arquivos Colossais, que chamaremos de Arquivos Nanicos. Para isso, este código junta todos os dados extraídos pelo CLoC em um único csv, além de juntar todos os arquivos grandes.
...
## Analisar cada Projeto para obter o número de Arquivos Nanicos por Projeto

Com esses resultados, definimos uma amostra para definir a quantidade de Arquivos Nanicos a serem usados para comparação. Esta amostra foi calculada usando a calculadora de amostras com 99% de confiança, 1% de erro e distribuição 80/20. Com esses valores, calculamos a quantidade de Arquivos Nanicos para cada projeto usando o seguinte cálculo. Primeiro, analisamos a proporção que os Arquivos Colossais de uma linguagem em um Projeto X representam no total de Arquivos Colossais que essa linguagem possui com essa proporção (X Arquivos Colossais Java/Total Arquivos Colossais Java). Com isso, aplicamos essa proporção à amostra da calculadora de amostras. Se um Projeto não puder conter o total de Arquivos Nanicos de uma linguagem, usaremos apenas os disponíveis para não comprometer a amostragem de outros Projetos.
...
5º - Mostrar quantos Arquivos Nanicos tem disponível no projeto
'''
...
## Selecionando Arquivos Nanicos por Projeto aleatoriamente

Tendo o número de Arquivos Nanicos de cada linguagem por Projeto, agora sorteamos aleatoriamente esse número de arquivos.
...
## Minerando commits de Arquivos Nanicos

Finalmente, tendo selecionado os Arquivos Nanicos, agora extraímos seus commits.
