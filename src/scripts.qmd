...
for language in listdir(input_path):
    ...
    for repository in listdir(language_path):
        if path.exists(f'{output_path}/{language}/{repository}.csv'):
            ...
            system(f'{cloc} --by-file-by-lang --csv --out {output_path}/{language}/{repository}.csv {input_path}/{language}/{repository}')
            
            new_formater(f'{output_path}/{language}/{repository}.csv')
