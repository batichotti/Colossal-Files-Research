...
for i in range(len(repositories)):
    ...
    if path.exists(f"{large_files_commits_path}{repo_path}"):
        ...
        calc_lines_changes(repository_large_files_commit).to_csv(f"{output_path}{repo_path}.csv")
        if (last_language == language):
    ...
    if path.exists(f"{small_files_commits_path}{repo_path}"):
        ...
        calc_lines_changes(repository_large_files_commit, "small").to_csv(f"{output_path}{repo_path}.csv")
        if (last_language == language):
